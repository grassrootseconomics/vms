...
try:
    ...
    bancorImage = pygame.image.load('bancor.png')
except:
    print("png loaded")
    ...
    if bprotocolMode == False:
        for le in legendSprites:
            if le.legendType == utils.EXCHANGE:
                newImage = pygame.image.load('bancor.png').convert_alpha()
                bancorImage = newImage
                le.image = newImage
...
legendSprites.add(legendDude(bancorImage, (legendOffsetX+250, legendOffsetY+80),utils.EXCHANGE))
